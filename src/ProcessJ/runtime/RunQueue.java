...
/**
 * A very simple linked-list implementation of a queue of 
 * processes - a run queue.
 * All this class' methods are called from Scheduler.java 
 *
...
public class RunQueue {
    /**
     * A linked list of PJProcess objects. Both ready and not ready
     * processes are stored in this list.
     */
    private LinkedList<PJProcess> queue = new LinkedList<PJProcess>();

    /**
     * @param p Inserts process p (of type PJProcess) into the run queue.
     */
    ...
    /**
     * Returns the size of the run queue - the total
     * number of processes (both ready and not ready)
