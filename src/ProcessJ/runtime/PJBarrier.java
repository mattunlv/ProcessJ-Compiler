...
public class PJBarrier {
    ...
    /**
     * Constructor. Any process that declares a barrier is itself enrolled on it; so enrolled count starts at 1.
     */
    public PJBarrier() {
        this.enrolled = 1;
    }
     ...
     *
     * @param process
     *            A reference to the process syncing - this is needed to set all processes ready when everyone has
     *            synced
     */
