...
public class PJAlt {
     ...
     * @param caseCount The number of guarded statements in this alt.
     * @param p The process in which this alt appears.
     */
    ...
    /**
     * Sets the guards and the Boolean pre-guards and returns
     * true if one or more of the Boolean pre-guards is true -- false
     * otherwise.
     * @param bg An array of Boolean values representing the values of the Boolean pre-guards.
    ...
    /**
     * Returns the index (of guards[]) of the first guard that is ready.
     * If no guard is ready, -1 is returned.
